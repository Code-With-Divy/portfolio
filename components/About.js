...
return (
<>
<section id='about' className='sansita-regular mt-[10vw] sm:mt-[8vw] m-10 mx-[1.5vmax] min-h-screen'>
      <div>
        ...
        <div className='my-[4.3vw] mx-[1.5vmax] text-[2.5vmax] text-slate-300 bg-[#0c0011]'>
          <p>
